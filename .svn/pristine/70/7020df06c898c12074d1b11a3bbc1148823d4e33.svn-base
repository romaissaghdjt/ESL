...
//    [self.view showBusyHUD];
    ...
    NSString *url = [PREURL stringByAppendingString:@"/Other.ashx?Function=HttpQueryWeddingCarDecorate"];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.img sd_setImageWithURL:[NSURL URLWithString:self.array[indexPath.section][@"Url"][indexPath.row]] placeholderImage:[UIImage imageNamed:@"Replac_img.png"]];
    return cell;
}

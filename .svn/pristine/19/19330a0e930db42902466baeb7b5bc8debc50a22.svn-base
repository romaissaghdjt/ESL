...
- (void)request
{
    ...
    NSString *ss = [PREURL stringByAppendingString:[NSString stringWithFormat:@"Other.ashx?Function=HttpQuerySeriesameInfo&SeriesameName=%@",self.mm.Seriesame]];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Name*model = self.ary[indexPath.section];
    [cell.img sd_setImageWithURL:[NSURL URLWithString:model.imageUrl] placeholderImage:[UIImage imageNamed:@"Replac_img.png"]];
    return cell;

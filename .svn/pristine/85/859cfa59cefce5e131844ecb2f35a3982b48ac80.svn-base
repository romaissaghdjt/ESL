...
- (void)requestLeft
{
    ...
    [zJRequestManager requestWithUrl:[PREURL stringByAppendingString: @"MenuHandler.ashx?Action=getStarLevels"] parmDic:nil method:GET1 succeedWithData:^(NSData *data) {

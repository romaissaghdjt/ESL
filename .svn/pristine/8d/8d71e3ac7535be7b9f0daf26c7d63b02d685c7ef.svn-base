...
//     [self.view showBusyHUD];
    [zJRequestManager requestWithUrl:[WeddURL stringByAppendingString: @"weddingHandler.ashx?Action=GetCase"] parmDic:nil method:GET1 succeedWithData:^(NSData *data) {
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if ([tableView isEqual:_rightTableView]) {
        ...
        if (!cell) {
            ...
            [cell.img sd_setImageWithURL:[NSURL URLWithString:_array[indexPath.row]]];

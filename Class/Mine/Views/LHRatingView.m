...
@property (nonatomic,assign)NSInteger lowestScore;//最低分数

@property (nonatomic,assign)NSInteger allScore;  //总分数
...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.widDistance = 1.0f;
        self.heiDistance = 1.0f;
...
//        
//        eachWidth = ((CGRectGetWidth(self.frame)-(starNumber-2)*self.widDistance)/starNumber-1);
//        CGFloat height = (CGRectGetHeight(self.frame)-3*self.heiDistance)*nil;
        
        eachWidth = (((CGRectGetWidth(self.frame)-(starNumber)*self.widDistance)/starNumber));
        CGFloat height = ((CGRectGetHeight(self.frame)*self.heiDistance));

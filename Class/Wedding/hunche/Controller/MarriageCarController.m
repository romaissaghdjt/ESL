...
- (void)request
{
    ...
    NSString *ss = [PREURL stringByAppendingString:@"Other.ashx?Function=HttpQuerySeriesames"];
...
-(UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    Name*mm = self.ary[indexPath.row];
    cell.textLabel.text = mm.Seriesame;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    Name*model= self.ary[indexPath.row];
    CarCVC.mm = model;

...
//     [self.view showBusyHUD];
    NSString*url =[WeddURL stringByAppendingString:@"JoinHandler.ashx?Action=GetCompanyCgy"];
    NSLog(@"%@",url);
...
#pragma mark  申请点击事件
    ...
    NSString *urls = [NSString stringWithFormat:[WeddURL stringByAppendingPathComponent:@"JoinHandler.ashx?Action=CompanyJoin&dateTime=%@&JoinselectID=%@&Company=%@&User=%@&Tel=%@"],self.day.text,self.Id,self.compnyTextField.text,self.nametextField.text,self.phoneTextFiled.text];

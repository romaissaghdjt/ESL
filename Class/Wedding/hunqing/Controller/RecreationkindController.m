...
- (void)request
{
    [zJRequestManager requestWithUrl:[PREURL stringByAppendingString:@"Other.ashx?Function=HttpQuerySongAndDance"] parmDic:nil method:GET1 succeedWithData:^(NSData *data) {
...
- (void)request1
{
    [zJRequestManager requestWithUrl:[PREURL stringByAppendingString:@"Other.ashx?Function=HttpQueryCeremony"] parmDic:nil method:GET1 succeedWithData:^(NSData *data) {
        NSArray*ARY = [NSJSONSerialization JSONObjectWithData:data options:(NSJSONReadingMutableContainers) error:nil];
        for (NSDictionary*dic in ARY) {
            WeddingKindModel *model = [[WeddingKindModel alloc]init];
            [model setValuesForKeysWithDictionary:dic];
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell.img sd_setImageWithURL:[NSURL URLWithString:model.Icon] placeholderImage:[UIImage imageNamed:@"Replac_img.png"]];
    return cell;
}

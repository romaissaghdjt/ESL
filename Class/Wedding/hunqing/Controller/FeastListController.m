...
- (void)request
{
    NSString*url =[PREURL stringByAppendingString:@"Other.ashx?Function=HttpQueryWiddingSetMeal"];
    NSLog(@"%@",url);
...
- (UITableViewCell*)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    [cell.Pimg sd_setImageWithURL:[NSURL URLWithString:model.ImageUrl] placeholderImage:[UIImage imageNamed:@"Replac_img.png"]];
    return cell;
}
